...
print("my name is: %s and my age is: %d and my rank is: %.2f" % (name1, age1, rank1))

x = "ahmed"
c = "python"
v = 20

print("my name is: %s I am a %s developer with %d years Exp" % (x, c, v))
...
n2 = "ahmed"
print("My Name is: {}".format(n2))

name2 = "ahmed"
age2 = 20
rank2 = 5
print("My Name is: {:s} and MY Age is: {:d} and MY Rank is: {:.2f}".format(name2, age2, rank2))
